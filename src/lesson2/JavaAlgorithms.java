...
public class JavaAlgorithms {
    ...
    /*
        ...
        Трудоёмкость:
            T = O(n^alpha), alpha определяется длиной подстроки и её характеристиками
        Ресурсы:
            R=O(n) -- так как размер map-ов и размер их содержимого линейно зависит размера входных данных.
